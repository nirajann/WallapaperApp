...
import com.example.artwallpaper.AboutActivity
...
class DownloadApater(val requireContext: Context, val listOfCategory: ArrayList<categoryModel>) : RecyclerView.Adapter<DownloadApater.bomViewHolder>(){
