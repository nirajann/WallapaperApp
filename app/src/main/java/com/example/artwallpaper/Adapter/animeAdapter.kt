...
class animeAdapter(val requireContext: Context, val listOfCategory: ArrayList<categoryModel>) : RecyclerView.Adapter<animeAdapter.bomViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): bomViewHolder {
        return bomViewHolder(
            LayoutInflater.from(requireContext).inflate(R.layout.item_anime,parent,false)
